...
[![IaC Bazaar: live-tested](https://www.iac-bazaar.com/api/artifacts/aws-secrets-manager/badge)](https://www.iac-bazaar.com/catalog/aws-secrets-manager?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
...
```
curl -s https://www.iac-bazaar.com/api/artifacts/aws-secrets-manager/verification
```

The receipt names every check that ran, when it ran, and the SHA-256 of the
archive it describes. Full detail: [www.iac-bazaar.com/catalog/aws-secrets-manager](https://www.iac-bazaar.com/catalog/aws-secrets-manager)

## Usage

```hcl
module "secrets_manager" {
  source  = "registry.terraform.io/CyberCoreSystems/secrets-manager/aws"
  version = "~> 1.0"
...
- Terraform module 1.0.0, live-tested on IaC Bazaar: [Secrets Manager Secret](https://www.iac-bazaar.com/catalog/aws-secrets-manager?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
